  ...
  <div>
    ...
    <div class="mb-6 flex items-center justify-between">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Создание меню</h2>
          <p class="text-gray-600 dark:text-gray-400 mt-1">Новое навигационное меню</p>
        </div>
      </div>
      <div class="flex gap-3">
        ...
        <ThemeButton variant="primary" @click="createMenu">
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
      <form @submit.prevent="createMenu" class="space-y-6">
        <!-- Name -->
        <div>
  ...
  try {
    ...
    if (response.ok) {
      ...
      if (data.errors) {
        ...
        errors.value = [data.message || 'Ошибка при создании меню'];
      }
    }
  } catch (error) {
    console.error('Failed to create menu:', error);
    errors.value = ['Ошибка при создании меню'];
  }
};
</script>
